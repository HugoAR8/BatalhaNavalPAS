...
public class mediumCannon : MonoBehaviour, Cannon
{
    ...
    public void Shoot()
    {
        //Os canhões médios diferentemente dos pequenos e grandes tem a habilidade de instanciar 2
        // balas ao invés de 1/3
